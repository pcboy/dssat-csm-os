...
!     REAL          VARVAL        ! Temporary variable             #
      ...
      CHARACTER (LEN=255) CFGDFILE      ! Configuration directory+file
...
!     CHARACTER (LEN=1)   CFLPRES       ! Control flag for headers,PRES
      ...
      CHARACTER (LEN=255)  FAPPLINE(30)  ! Fertilizer application details
      CHARACTER (LEN=255) FILEA         ! Name of A-file
      CHARACTER (LEN=255) FILEX         ! Name of X-file
      CHARACTER (LEN=255) FILEIO        ! Name of input file,after check
      CHARACTER (LEN=255) FILEIOIN      ! Name of input file
      CHARACTER (LEN=107) FILEADIR      ! Name of A-file directory      
      CHARACTER (LEN=3)   FILEIOT       ! Type of input file
      CHARACTER (LEN=255) FILENEW       ! Temporary name of file
      CHARACTER (LEN=255) FILET         ! Name of T-file
      CHARACTER (LEN=1)   FNAME         ! File name switch (N->standard)
      CHARACTER (LEN=255) FNAMEERA      ! File name,A-errors
      CHARACTER (LEN=255) FNAMEERT      ! File name,T-errors
      CHARACTER (LEN=255) FNAMEEVAL     ! File name,evaluate outputs
      CHARACTER (LEN=255) FNAMELEAVES   ! File name,leaves outputs
      CHARACTER (LEN=255) FNAMEMEAS     ! File name,measured outputs
      CHARACTER (LEN=255) FNAMEOV       ! File name,overview outputs
      CHARACTER (LEN=255) FNAMEPHASES   ! File name,phases outputs
      CHARACTER (LEN=255) FNAMEPHENOLM  ! File name,phenology measured
      CHARACTER (LEN=255) FNAMEPHENOLS  ! File name,phenology outputs
      CHARACTER (LEN=255) FNAMEPREM     ! File name,responses,measured
      CHARACTER (LEN=255) FNAMEPRES     ! File name,responses,simulated
      CHARACTER (LEN=255) FNAMEPSUM     ! File name,plant summary
...
!     CHARACTER (LEN=354) LINEERA       ! Temporary line,error-a file
      CHARACTER (LEN=255)  LINESTAR      ! Group header line (with star)
      CHARACTER (LEN=255)  LINESTAR2     ! Group header line (with star)
...
!     CHARACTER (LEN=1)   MENU          ! Switch,root N uptake methd
      ...
      CHARACTER (LEN=255)  PATHCR        ! Path to genotype (CUL) files
      CHARACTER (LEN=255)  PATHEC        ! Path to genotype (ECO) files
      CHARACTER (LEN=255)  PATHSP        ! Path to genotype (SPE) files
...
!-----------------------------------------------------------------------
     ...
     &                 LINESTAR(1:LENLINESTAR)//LINET(14:LENLINE)
                      IF (IDETG.NE.'N') THEN 
                        WRITE (FNUMMEAS,*) ' '
                        WRITE (FNUMMEAS,'(A255)') LINESTAR2(1:255)
                        WRITE (FNUMMEAS,*) ' '
