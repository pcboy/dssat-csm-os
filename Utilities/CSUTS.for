...
!-----------------------------------------------------------------------
      ...
      DO loop=1,2000
       READ(fnumcfg,'(A255)',ERR=1000,END=1000)tline
...
!      INTRINSIC EOF   !portability
      ...
      ELSE
        ...
        READ(FNUMTMP,'(A255)',IOSTAT=ERRNUM) TLINE    !portability      
...
!-----------------------------------------------------------------------
 ...
 30   READ(LUN,'(A)',ERR=70,END=70)CHARTEST
      ...
      IF(CHARTEST(1:1).NE.'!' .AND. CHARTEST(1:1).NE.'@') THEN
         IF(CHARTEST(1:255).NE.BLANK)THEN
