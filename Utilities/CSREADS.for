...
!-----------------------------------------------------------------------
     ...
     &  Standard
      ...
      DO WHILE(tl0801(1:GROUPLEN).NE.GROUP(1:GROUPLEN))
        READ(filenum,'(A255)',END=9996,ERR=9999)tl0801
        CALL Ltrim(tl0801)
...
!      WRITE(fnumrea,*)' SOIL CODE     ',SLCODE
      ...
      tl0801=' '
      DO WHILE(tl0801(1:GROUPLEN).NE.GROUP(1:GROUPLEN))
        READ(filenum,'(A255)',END=9998,ERR=9999)tl0801
